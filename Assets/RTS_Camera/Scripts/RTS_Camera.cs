...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void LimitPosition()
        {
            ...
            m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, startPosition.x - limitX, startPosition.x + limitX),
                m_Transform.position.y,
                Mathf.Clamp(m_Transform.position.z, startPosition.z - limitY, startPosition.z + limitY));
        }
